Sub EnhancedSearchEmails()
    ...
    searchDate = InputBox("Enter Date to search (leave blank to skip):", "Search by Date")
    searchSenderName = InputBox("Enter Sender Name to search (leave blank to skip):", "Search by Sender Name")
    searchSenderEmail = InputBox("Enter Sender Email to search (leave blank to skip):", "Search by Sender Email")
    searchSubject = InputBox("Enter Subject to search (leave blank to skip):", "Search by Subject")

    ' If all inputs are blank, exit
    If searchDate = "" And searchSenderName = "" And searchSenderEmail = "" And searchSubject = "" Then
